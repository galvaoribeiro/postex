...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Conta" description="Sua conta e as capacidades de IA disponiveis." />
      ...
      {capabilities && (
        <Card>
          ...
          <CardContent className="grid grid-cols-2 gap-3 text-sm sm:grid-cols-3">
            ...
            <InfoItem label="Imagem" value={`${capabilities.image_provider} · ${capabilities.image_model}`} />
